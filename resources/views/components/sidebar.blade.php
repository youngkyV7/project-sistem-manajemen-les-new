    ...
    <nav class="mt-6 space-y-2">
        ...
        <a href="{{ route('recyclebin') }}"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" height="18" width="18" fill="white" viewBox="0 0 24 24">
                <path
                    d="M9 3v1H4v2h1v13a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V6h1V4h-5V3a1 1 0 0 0-1-1H10a1 1 0 0 0-1 1zm0 3h6v13H9V6zm2 2h2v9h-2V8z" />
            </svg>
            <span x-show="sidebarOpen" x-transition class="ml-3">Recycle Bin</span>
        </a>

        <a href="{{ route('embed.index') }}"
            class="flex items-center px-4 py-2 hover:bg-indigo-700 transition rounded-md">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="white" viewBox="0 0 24 24">
                <path
                    d="M8.59 16.59 4 12l4.59-4.59L7.17 6l-6 6 6 6 1.42-1.41zm6.82 0L20 12l-4.59-4.59L16.83 6l6 6-6 6-1.42-1.41zM14 4l-4 16h2l4-16h-2z" />
            </svg>
            <span x-show="sidebarOpen" x-transition class="ml-3">Link Konversi Embed</span>
        </a>
