...
<body class="bg-gray-50 font-sans">
  <nav x-data="{ open: false }" class="bg-white shadow-md text-lg fixed w-full top-0 left-0 z-50">
    <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
      ...
      <button
        ...
        <span class="w-7 h-1 bg-gray-700 rounded block"></span>
        <span class="w-7 h-1 bg-gray-700 rounded block"></span>
        <span class="w-7 h-1 bg-gray-700 rounded block"></span>
      </button>
      ...
      <ul class="hidden md:flex space-x-8 text-gray-700 font-medium items-center">
        ...
        <li><a href="#hasil" class="hover:text-indigo-600 transition">Hasil Karya</a></li>
        <li>
          <a href="https://wa.me/628988888369" target="_blank"
    ...
    <div
      x-show="open"
      x-transition
      class="md:hidden bg-white shadow-md px-6 pb-4">
      <ul class="flex flex-col space-y-4 text-gray-700 font-medium">
        <li><a href="#tentang" class="block hover:text-indigo-600 transition">Tentang Kami</a></li>
        <li><a href="#hasil" class="block hover:text-indigo-600 transition">Hasil Karya</a></li>
        <li>
          <a
