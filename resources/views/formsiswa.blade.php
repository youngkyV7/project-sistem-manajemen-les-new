            ...
            <form action="{{ route('siswa.add', ['token' => $token]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid lg:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="nama_siswa" placeholder="Masukkan Nama" class="px-4 py-2.5 border border-gray-400 w-full text-lg rounded-md focus:outline-blue-600" />
                    </div>
                    <div>
                    ...
                    <div>
                        <label class="text-lg font-medium block mb-2">Kota</label>
                        <input type="text" name="kota" placeholder="Masukkan Kota" class="px-4 py-2.5 border border-gray-400 w-full text-lg rounded-md focus:outline-blue-600" />
                    </div>
                    <div>
